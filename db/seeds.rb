...
user1 = User.create(first_name: "Po", last_name: "Ng", email: "popo@hello.com", password: "123456")
...
user2 = User.create(first_name: "Hey", last_name: "Lol", email: "kekeke@hello.com", password: "123456")
...
user3 = User.create(first_name: "Hey", last_name: "Lol", email: "kekeke@hello.com", password: "123456")
...
user4 = User.create(first_name: "Hey", last_name: "Lol", email: "kekeke@hello.com", password: "123456")
